...
import { AccountViewModel, DataService, SearchModel } from 'src/app/core';
import { ToastrService } from 'ngx-toastr';
import { NgbModal } from '@ng-bootstrap/ng-bootstrap';

@Component({
  selector: 'app-insurancepopup',
  templateUrl: './insurancepopup.component.html',
  styleUrls: ['./insurancepopup.component.scss']
})
export class InsurancepopupComponent implements OnInit {
